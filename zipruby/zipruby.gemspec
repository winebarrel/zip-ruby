Gem::Specification.new do |spec|
  ...
  spec.files             = %w(ext/zipruby.c ext/zipruby.h ext/zipruby_archive.c ext/zipruby_archive.h ext/zipruby_file.c ext/zipruby_file.h ext/zipruby_stat.c ext/zipruby_stat.h ext/zipruby_zip.c ext/zipruby_zip.h ext/extconf.rb)
